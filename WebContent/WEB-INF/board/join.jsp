...
<script type="text/javascript">
	...
	function passwordCheck() {
		if($("#member_pw").val()!= $("#userPwCheck").val()){
	...
	<form action="join.do" method="post" onsubmit="return passwordCheck()">
		<fieldset>
			...
			<label for = "userPw">&nbsp;비밀번호 :</label>
				<input type = "password" id = "member_pw" name = "member_pw" class = "LoginInput" />
				<span class = "error"><form:errors path="MemberModel.member_pw"/></span><br />
			<label for = "userPwCheck">&nbsp;비밀번호 확인 :</label>
				<input type ="password" id = "userPwCheck" name ="userPwCheck" class = "LoginInput" /><br />
			<label for = "userName">&nbsp;회원이름 : </label>
				<input type="text" id ="member_name" name = "member_name" class = "LoginInput" />
				<span class ="error"><form:errors path="MemberModel.member_name" /></span><br /><br />
				<center>
