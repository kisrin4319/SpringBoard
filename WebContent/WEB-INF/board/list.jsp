...
<div class = "wrapper">
	<div class = "navBar">
		...
		<form action="list.do" method="get">
			...
			<input type = "text" id = "keyword" name = "keyword" value = "<%if(request.getParameter("keyword")!=null){ out.print(request.getParameter("keyword")); }
			else {
				out.print("");}	%>" />
		...
		<tbody>
			<c:forEach var = "board" items = "${boardList}">
				<tr>
					...
					<td class = "writer">
					<c:choose>
						<c:when test = "${board.writerId ==member_id}"><strong>${board.writer }</strong></c:when>
