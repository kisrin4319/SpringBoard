	...
	<h3>스프링 게시판</h3>
		...
		<form action="login.do" method="post">
			<fieldset>
				...
				<input type="text" id = "member_id" name = "member_id" class = "loginInput" value ="${member_id}" />
				<span class = "error"><form:errors path = "LoginModel.member_id" /></span><br />
				<label for = "userPw">비밀번호 : </label>
				<input type ="password" id = "member_pw" name = "member_pw" class ="loginInput" />
				<span class = "error"> <form:errors path = "LoginModel.member_pw" /></span><br /><br />
				<center>
